...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(BogMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(BogMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(BogMod.makeImagePath("masks/PowerMask.png"));
    ...
    public static void computeCard(AbstractBogCard c) {
