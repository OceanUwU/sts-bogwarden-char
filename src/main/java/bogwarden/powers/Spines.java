...
public class Spines extends AbstractBogPower {
    ...
    public static class Trigger {
        private static AbstractMonster.Intent[] excludedIntents = new AbstractMonster.Intent[]{AbstractMonster.Intent.ATTACK, AbstractMonster.Intent.ATTACK_BUFF, AbstractMonster.Intent.ATTACK_DEBUFF, AbstractMonster.Intent.ATTACK_DEFEND};
        ...
        public static void Insert(GameActionManager __instance, AbstractMonster m) {
            ...
            if (AbstractDungeon.player.hasPower(POWER_ID))
                ((Spines)AbstractDungeon.player.getPower(POWER_ID)).trigger(m);
        }
    }
}