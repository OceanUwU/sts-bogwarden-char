...
public class Act1BogArchetype extends ArchetypeBaseBogwarden {
    public Act1BogArchetype() {
        super(makeID("BOG_ARCHETYPE_1"), "Act1");
    ...
    public static class SpecialPower extends AbstractBossMechanicPower {
        public static final String POWER_ID = makeID("Act1SpecialPower");
