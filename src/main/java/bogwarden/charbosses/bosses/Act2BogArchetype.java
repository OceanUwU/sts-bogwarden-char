...
public class Act2BogArchetype extends ArchetypeBaseBogwarden {
    public Act2BogArchetype() {
        super(makeID("BOG_ARCHETYPE_2"), "Act2");
    ...
    public static class SpecialPower extends AbstractBossMechanicPower {
        public static final String POWER_ID = makeID("Act2SpecialPower");
